      ...
      <section className="border-y border-border/60 bg-card">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-20 md:py-28 grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 lg:col-start-6 prose-r space-y-5 text-[1.02rem]">
            <p>In 2009, Paul founded Lexington North, building it into the largest specialist planning communications consultancy in Northern England. Under his leadership, the firm advised many of the UK's leading developers, land promoters, infrastructure providers and public sector organisations, earning a reputation as one of the country's foremost advisers in planning and development communications. In 2022, the business was successfully acquired by a leading international communications group. Following the acquisition, Paul continued to provide senior strategic counsel on nationally significant development and infrastructure projects.</p>
