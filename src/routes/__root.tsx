...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Racefield Consulting is the advisory practice of Paul Boyfield, providing senior political, stakeholder and planning communications advice to UK developers, landowners and infrastructure providers." },
      { name: "author", content: "Racefield Consulting" },
      { property: "og:title", content: "Racefield Consulting — Political insight. Strategic communications." },
      { property: "og:description", content: "Racefield Consulting is the advisory practice of Paul Boyfield, providing senior political, stakeholder and planning communications advice to UK developers, landowners and infrastructure providers." },
